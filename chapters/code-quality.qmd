...
les enjeux de la qualité du code, les principaux généraux pour améliorer
celuici et quelques outils ou gestes faciles à mettre en oeuvre
...
Nous recommandons plutôt de voir les bonnes pratiques comme de bonnes habitudes à acquérir en opérant un va-et-vient régulier entre la pratique et la théorie. Les outils
...
pratiques serait coûteuse en temps et donc difficile à mettre en oeuvre
...
est plus ou moins instantanée et économise un temps précieux dans la vie
...
qui peut être chronophage et ainsi pénibles à appliquer
...
a émergé pour intégrerà `Black` des diagnostics
...
plus complexe à mettre en oeuvre que la programmation fonctionnelle. Dans de 
...
- Améliorer la __lisibilité__ du code en permettant aux lecteurs
de comprendre le lien entre les objets créés dans le code
ainsi que la manière dont un bloc de code s'inscrit
dans la démarche plus globale ;
