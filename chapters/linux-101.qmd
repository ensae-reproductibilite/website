---
title: "Linux 101"
subtitle: "Démystifier le terminal Linux pour gagner en autonomie"
author: "Romain Avouac et Lino Galiana"
image: https://minio.lab.sspcloud.fr/lgaliana/generative-art/mise-en-prod/penguin.png
description: |
...
./test.sh #<2>
```
1. Créer le script test.sh (vide)
2. Exécuter le script test.sh
...
```
1. Donner des droits d'exécution au script `test.sh`
2. Exécuter le script test.sh
