...
Celui-ci sauvegarde votre avancée dans un tag nommé `dev_before_appli9` (au cas où vous voudriez revenir sur votre version ultérieurement) puis force votre branche à adopter l'état du tag `appli9`.
