...
[Script _checkpoint_](https://raw.githubusercontent.com/linogaliana/ensae-reproductibilite-application/main/checkpoints/application2/titanic.py)
:::

## Etape 3: gestion des paramètres

- 1 fichier `secrets.yaml`: jeton d'API
- 1 fichier `config.yaml`: chemins + un paramètre comme le split train/test
