...
::: {.callout-tip}
## Projet d'application 19a: Mettre à disposition l'API (déploiement continu)
...
- Observer l'évolution de l'état de votre plateforme, une fois
...
Pour cela, mettre à jour les fichiers suivants:
...
- Ajouter la ligne `/.quarto/` au `.gitignore`
- Déplacer `website.qmd` vers la racine de notre projet et renommer `index.qmd`
