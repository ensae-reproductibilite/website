...
Pour rappel, nous visons la structure de projet suivante:
...
![](/website/chapters/applications/figures/pipeline_appli8.png)
...
- La __configuration__. Ici, on peut considérer que notre YAML de configuration relève de cette catégorie  ;
