...
1. Avec des arguments optionnels appelés depuis la ligne de commande _(Application 3a)_.
...
le script principal _(Application 3b)_. Nous allons le mettre en oeuvre pour deux types de fichiers:
...
::: {.callout-tip}
## Application 3b: Extraction des secrets
...
4. Créer une condition logique pour tenir compte du fait que `config.yaml`
...
5. Créer la variable `API_TOKEN` ayant la valeur stockée dans `secrets.yaml`.
