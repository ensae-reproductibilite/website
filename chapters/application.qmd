...
2. Créer un script dans `mlflow/predict.py` avec le contenu ci-dessous pour
créer les données utiles à 
...
2. Aller dans l'onglet `Models` et observer le changement. 
3. Remplacer dans 
`mlflow/predict.py`
...
Modifier le code de l'API et faire
