...
1. Modifier `src/models/train_evaluation.py` 
...
2. Introduire une validation croisée par _grid search_ dans `train.py`
...
Tester votre script et corriger

1. Lancer MLFlow depuis l'onflet Mes services
https://datalab.sspcloud.fr/catalog/automation

Sur l'UI MLFlow (forme https://user-{username}-{pod_id}.user.lab.sspcloud.fr), 
