...
# Partie 2bis: packagisation de son projets (optionnel)
...
- Effectuer le test unitaire en ligne de commande avec `pytest`. Corriger le test unitaire en cas d'erreur. 
