...
description: |
  Introduction à l'utilisation de `YAML`, un langage devenu incontournable dans l'éco-système DevOps pour sa capacité à produire des fichiers de configuration déclaratifs lisibles et expressifs.
order: 7.5
