...
liste de package
2. Créer l'environnement virtuel `titanic` en s'inspirant de [la documentation officielle](https://packaging.python.org/en/latest/guides/installing-using-pip-and-virtual-environments/)[^pythonversion] ou du [chapitre dédié](/chapters/portabilite.qmd)
...
10. Quand `main.py` fonctionne, faire `pip freeze > requirements.txt` pour figer l'environnement de travail.
11. Ajouter le dossier `titanic/` au `.gitignore` pour ne pas ajouter ce dossier à `Git`.
