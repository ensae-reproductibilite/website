...
- Remplacer le contenu de `index.qmd` par [celui-ci](https://raw.githubusercontent.com/ensae-reproductibilite/application/refs/tags/appli20/index.qmd) et retirer `about.qmd` des fichiers à compiler.
