...
spec:
  ...
  tls:
  - hosts:
    - nom-appli.lab.sspcloud.fr #<1>
  rules:
  - host: nom-appli.lab.sspcloud.fr #<1>
    http:
      paths:
      - path: /
        pathType: Prefix
        backend:
          service:
            ...
            port:
              number: 80
```
1. Mettez l'URL auquel vous voulez exposer votre service. Sur le modèle de `titanic-ensae.lab.sspcloud.fr` (mais ne tentez pas celui-là, il est déjà pris 😃)
