...
* Le _pipeline_ `Scikit` d'estimation et d'évaluation vous a été donné tel quel. Regardez le code équivalent dans `Scikit` ci-dessous:
...
* Créer un _notebook_ brouillon commençant par le code suivant:
...
Maintenant, revenons à notre chaine de production.
