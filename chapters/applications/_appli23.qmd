...
6. On va retirer l'entraînement de la séquence d'opération du `Dockerfile`. En supprimant la ligne relative à l'entraînement du modèle, vous devriez avoir
...
2. La variable d'environnement à adapter en fonction de l'adresse du dépôt de modèles utilisé
