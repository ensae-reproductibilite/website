...
::: {.callout-tip}
## Objectif
à partir d'un projet existant ou d'un projet que vous construirez, développer une application interactive / un dashboard répondant à une problématique métier, puis la déployer sur une infrastructure de production.
:::
