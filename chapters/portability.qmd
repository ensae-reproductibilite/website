...
Si le premier problème peut être géré relativement facilement en adoptant une [structure de projet](XXXXXX) et en spécifiant bien les différentes dépendances utilisées, les deux autres nécessitent en général des outils plus avancés.
